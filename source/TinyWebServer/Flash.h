...
//#define Fmod(str, args) (_FLASH_STRING().Printable(PSTR(str), args))


//char *builder(char *str_h, const char *fmt, va_list ap){
//    /* va_list ap; */
//    char *p;
//    char *sval;
//    int32_t c;
...
//  _FLASH_STRING();
  ...
  {
    return size == -1 ?			// wouldn't be always false? compiler complains about this
...
//  const _Printable &Printable(const char *fmt_s, ...) const
//  {   va_list ap;
//  	  va_start(ap, fmt_s);
//	  char *tmp = builder((char*)_arr, fmt_s, ap);
//	  va_end(ap);
//	  strcpy_P((char*)_arr, (const char*)tmp);
//	  free(tmp);
//	  return *this; }
