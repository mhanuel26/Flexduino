...
#define WEBSOCKETS_SERVER_CLIENT_MAX  (7)
...
//        WEBSOCKETS_NETWORK_SERVER_CLASS * _server;
        ...
        WEBSOCKETS_NETWORK_SERVER_CLASS server_;
        WEBSOCKETS_NETWORK_CLIENT_CLASS	client_;
        ...
        bool newClient(WEBSOCKETS_NETWORK_CLIENT_CLASS * TCPclient);
