...
#else
#define WEBSOCKETS_NETWORK_TYPE NETWORK_WINC1500
#endif
...
#include "Server.h"
#include "Client.h"
#define WEBSOCKETS_NETWORK_CLIENT_CLASS WiFiClient
#define WEBSOCKETS_NETWORK_SERVER_CLASS WiFiServer
...
class WebSockets {
    protected:
        ...
        virtual void messageReceived(WSclient_t * client, WSopcode_t opcode, uint8_t * payload, size_t length) = 0;
